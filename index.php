...
?>
    ...
    <p>di website demo SMK Negeri 4 Banjarmasin</p>
    <a href="https://smkn4bjm.sch.id/" class="cta" target="_blank" >Official website here</a>
    </main>
    </section>
    <!-- Hero Section end -->
...
Khataman Alquran ini bebernya merupakan instruksi dari Gubernur Kalimantan Selatan, Sahbirin Noor. <a href="berita5.php">baca selengkapnya....</a>
    ...
    <h2><span>Manajemen </span>Sekolah</h2> 
     <div class="manajemen-container">
        ...
        <a href="manajemen.php" class="manajemen-box">
            <div>
